...
[![N|Solid](https://bridge.dogcoin.network/assets/img/logo.png)](https://dogcoin.network)



[![Build Status](https://travis-ci.org/joemccann/dillinger.svg?branch=master)](https://dogcoin.network)

## Instructions to setup Validator node

`Dogcoin Validator Node` is very easy to install and deploy in a Docker container. This requires [Docker](https://docs.docker.com/engine/install/) and [Docker Compose](https://docs.docker.com/compose/install/) to run. 
